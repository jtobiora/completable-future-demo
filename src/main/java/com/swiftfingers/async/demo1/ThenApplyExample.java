...
public class ThenApplyExample {
    ...
    public  CompletableFuture<Void> sendReminderToEmployee() {
        ...
        CompletableFuture<Void> voidCompletableFuture = CompletableFuture.supplyAsync(() -> {
            ...
            log.info("filter new joiner employee  : " + Thread.currentThread().getName());
            return employees.stream()
                    .filter(employee -> "TRUE".equals(employee.getNewJoiner()))
                    .collect(Collectors.toList());
        },executor).thenApplyAsync((employees) -> {
            log.info("filter training not complete employee  : " + Thread.currentThread().getName());
            return employees.stream()
            ...
            emails.forEach(ThenApplyExample::sendEmail);
        },executor);
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        ThenApplyExample service=new ThenApplyExample();
